...
from .data_structure import threadsafe_collections
from .zother import null
...
class Server:
    def __init__(self):
        ...
        self.requests = threadsafe_collections.SafeList()
        self.thread = None
        self.stop_event = libthreading.threading.Event()
        self.connects = []
        self.events = threadsafe_collections.SafeList()
        self.events.list *= 10
